...
class CustomBriefController extends AbstractController
{
    ...
    {
        $immersion = $entityManager->getRepository(Brief::class)->find($id);
        ...
        if ($nouveauFichier !== null && $nouveauFichier->isValid()) {
            ...
            $ancienFichier = $this->getParameter('kernel.project_dir') . '/public/fichiers/briefs/' . $immersion->getNomFichier();
